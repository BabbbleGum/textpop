...
const Logo = ({ className }: { className?: string }) => {
	return (
		<div className={cn("flex items-center justify-center", className)}>
			...
			>
				{/* Speech bubble shape */}
				<path d="M50 0H10C4.5 0 0 4.5 0 10V35C0 40.5 4.5 45 10 45H15V55L30 45H50C55.5 45 60 40.5 60 35V10C60 4.5 55.5 0 50 0Z" fill="#FF5B9F"/>
				...
				{/* Screen corner */}
				<rect x="35" y="25" width="10" height="10" rx="2" fill="#4FD1FF"/>
			</svg>
		</div>
	)
}
